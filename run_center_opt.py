...
adots_opt = np.loadtxt(in_dir + 'opt_m_error.txt')
...
np.savetxt('paleo_runs/center_opt_error/opt_ages.txt', np.array(ages))
np.savetxt('paleo_runs/center_opt_error/opt_Ls.txt', np.array(Ls))

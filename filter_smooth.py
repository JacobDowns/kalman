...
model_inputs = PaleoInputs('paleo_inputs/filter_start.hdf5', dt = dt)
...
for i in range(N):
    ...
    L_sigma2 = 50e6 #min(1000000., model.t*25000.) #1600000 #min(1600000., 500e3 + model.t*25000.)
    # Process noise
    Q = 0.1
    ...
    Ls.append(L)
    print "dif", L - L_mu
    print "H_min", model.H0_c.vector().min(), model.H0_c.vector().get_local().argmin()

...
ages = np.loadtxt('/media/jake/drive1/transform_buizert/north2/opt2/opt_age.txt')
Ls1 = np.loadtxt('/media/jake/drive1/transform_buizert/north2/opt2/opt_L.txt') / 1000.

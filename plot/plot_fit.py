...
ages = np.loadtxt('transform/center8/opt2/opt_age.txt')
Ls =   np.loadtxt('transform/center8/opt2/opt_L.txt')
#p = np.loadtxt('transform/center5/opt1/opt_p.txt')
#m = np.loadtxt('transform/center6/prior_m.txt')

#plt.plot(m)
#plt.show()
#quit()
#vs =   np.loadtxt('transform/center5/opt1/v.txt')
#sigma_ts = np.loadtxt('transform/center5/sigma_ts.txt')
#print sigma_ts[1] - sigma_ts[0]
#quit()

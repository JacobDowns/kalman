...
ts = np.loadtxt('../transform_start/center2_low1/sigma_ts.txt')
m1 = np.loadtxt('../transform_start/center2_low1/opt1/opt_m.txt')
P1 = np.loadtxt('../transform_start/center2_low1/opt1/opt_P.txt')
m2 = np.loadtxt('../transform_start/center2_1/opt1/opt_m.txt')
P2 = np.loadtxt('../transform_start/center2_1/opt1/opt_P.txt')
m3 = np.loadtxt('../transform_start/center2_high1/opt1/opt_m.txt')
P3 = np.loadtxt('../transform_start/center2_high1/opt1/opt_P.txt')
...
samps = (s1.T*w1).T + (s2.T*w2).T + (s3.T*w3).T

...
ages = np.loadtxt('transform_early/center1_new/sigma_ts.txt')
#ages1 = np.loadtxt('transform_final/center1_new/opt1/opt_age.txt')

#L1 = np.loadtxt('transform_final/center2/opt1/opt_L.txt')
#L2 = np.loadtxt('transform_final/south2/opt1/opt_L.txt')

p1 = np.loadtxt('transform_early/center1_new/opt1/opt_m.txt')
p2 = np.loadtxt('transform_early/center1_new/opt2/opt_m.txt')

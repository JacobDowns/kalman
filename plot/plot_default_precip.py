...
Ls1 = np.loadtxt('default_runs/center/L.txt')
Ls2 = np.loadtxt('default_runs/south/L.txt') 
Ps1 = np.loadtxt('default_runs/center/P.txt') / Ls1
Ps2 = np.loadtxt('default_runs/south/P.txt') / Ls2

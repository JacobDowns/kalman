...
dt1 = np.loadtxt('transform/north1/opt1/opt_m.txt')
v1 = np.loadtxt('transform/north1/opt1/v.txt')
dt2 = np.loadtxt('transform/center1/opt1/opt_m.txt')
v2 = np.loadtxt('transform/center1/opt1/v.txt')
dt3 = np.loadtxt('transform/south1/opt1/opt_m.txt')
v3 = np.loadtxt('transform/south1/opt1/v.txt')
...
#ages / 1000.
plt.plot(ages, dt1, '#d62728', lw = 1.5, label = 'North', marker = 'o', ms = 2)
plt.plot(ages, dt1 - 2.0*np.sqrt(v3), '#d62728', lw = 1.5, linestyle = '--')
plt.plot(ages, dt1 + 2.0*np.sqrt(v3), '#d62728', lw = 1.5, linestyle = '--')
plt.plot(ages, dt2, '#2ca02c', lw = 1.5, label = 'Center', marker = 'o', ms = 2)
plt.plot(ages, dt2 - 2.0*np.sqrt(v1), '#2ca02c', lw = 1.5, linestyle = '--')
plt.plot(ages, dt2 + 2.0*np.sqrt(v1), '#2ca02c', lw = 1.5, linestyle = '--')
plt.plot(ages, dt3, '#1f77b4', lw = 1.5, label = 'South', marker = 'o', ms = 2)
plt.plot(ages, dt3 - 2.0*np.sqrt(v2), '#1f77b4', lw = 1.5, linestyle = '--')
plt.plot(ages, dt3 + 2.0*np.sqrt(v2), '#1f77b4', lw = 1.5, linestyle = '--')

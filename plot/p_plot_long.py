...
# Default params
p1a = np.loadtxt('transform_long/center3/opt1/opt_m.txt')
L1 = np.loadtxt('transform_long/center3/opt1/opt_L.txt')
p1 = np.loadtxt('transform_long/center3/opt1/opt_p.txt') / L1
v1 = np.loadtxt('transform_long/center3/opt1/v.txt')

# beta2 0
p2a = np.loadtxt('transform_long/beta2_0/opt1/opt_m.txt')
L2 = np.loadtxt('transform_long/beta2_0/opt1/opt_L.txt')
p2 = np.loadtxt('transform_long/beta2_0/opt1/opt_p.txt') / L2
v2 = np.loadtxt('transform_long/beta2_0/opt1/v.txt')
...
plt.plot(tsa, p2a, '#1f77b4', lw = 2.5, label = r'$\beta^2 = 7.5 \times 10^{-4}$', marker = 'o', ms = 5, linestyle = '-')
...
plt.plot(tsa, p4a, '#d62728', lw = 2.5, label = r'$\beta^2 = 1.25 \times 10^{-3}$', marker = 'o', ms = 5, linestyle = '-')
...
plt.tight_layout()
#plt.show()
plt.savefig('long_precip.png', dpi=700)

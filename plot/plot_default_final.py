...
plt.title('(a)')
ts = np.linspace(-11.6e3, -7.3e3, 400)
#[11, 2, 5, 8]
plt.plot(ts, dt_functions[11](ts), color = 'k', lw = 3)
plt.plot(ts, dt_functions[11](ts), color = current_palette[0], lw = 2.5, label = 'Dec.')
plt.plot(ts, dt_functions[2](ts), color = 'k', lw = 3)
plt.plot(ts, dt_functions[2](ts), color = current_palette[-3], lw = 2.5, label = 'Mar.')
plt.plot(ts, dt_functions[5](ts), color = 'k', lw = 3)
plt.plot(ts, dt_functions[5](ts), color = current_palette[-1], lw = 2.5, label = 'Jun.')
plt.plot(ts, dt_functions[8](ts), color = 'k', lw = 3)
plt.plot(ts, dt_functions[8](ts), color = current_palette[2], lw = 2.5, label = 'Sep.')

...
plt.title('(a)')
plt.plot(ages, delta_temp1, 'k--', lw = 3, label = 'Dahl-Jensen')
plt.plot(ages, delta_temp2, 'k-', lw = 3, label = 'Buizert')
...
plt.title('(d)')
plt.plot(ages, Ls5, 'k--', lw = 3)
plt.plot(ages, Ls6, 'k-', lw = 3)

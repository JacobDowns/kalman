...
p1a = np.loadtxt('transform_buizert/north2/opt1/opt_m.txt')
L1 = np.loadtxt('transform_buizert/north2/opt1/opt_L.txt')
p1 = np.loadtxt('transform_buizert/north2/opt1/opt_p.txt') / L1
v1 = np.loadtxt('transform_buizert/north2/opt1/v.txt')

p2a = np.loadtxt('transform_buizert/center2/opt1/opt_m.txt')
L2 = np.loadtxt('transform_buizert/center2/opt1/opt_L.txt')
p2 = np.loadtxt('transform_buizert/center2/opt1/opt_p.txt') / L2
v2 = np.loadtxt('transform_buizert/center2/opt1/v.txt')

p3a = np.loadtxt('transform_buizert/south2/opt1/opt_m.txt')
L3 = np.loadtxt('transform_buizert/south2/opt1/opt_L.txt')
p3 = np.loadtxt('transform_buizert/south2/opt1/opt_p.txt') / L3
v3 = np.loadtxt('transform_buizert/south2/opt1/v.txt')

tsa = np.loadtxt('transform_buizert/center2/sigma_ts.txt')
ts = np.loadtxt('transform_buizert/center2/opt1/opt_age.txt')
...
ts_fine = np.loadtxt('transform_buizert/center2/age_0.txt')
Ls1 = np.loadtxt('transform_buizert/north2/opt1/opt_L.txt')
Ls2 = np.loadtxt('transform_buizert/center2/opt1/opt_L.txt')
Ls3 = np.loadtxt('transform_buizert/south2/opt1/opt_L.txt')
...
plt.tight_layout()
#plt.show()
plt.savefig('buizert_precip.png', dpi=700)

...
"""
Sensitivity experiment varying lambda_ice.
"""
...
params1 = [5.5, 0.005, 0.008 - ratio*0.008, 0.07, 0.75, 1e-3]
params2 = [5.5, 0.005, 0.008, 0.07, 0.75, 1e-3]
params3 = [5.5, 0.005, 0.008 + ratio*0.008, 0.07, 0.75, 1e-3]
...
for i in indexes:
    ...
    plt.plot(ages, Ls, label = r'$\lambda_i$ = ' + str(params[2]))
